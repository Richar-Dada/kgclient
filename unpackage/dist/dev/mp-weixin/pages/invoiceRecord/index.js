...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/invoiceRecord/index.vue */ 32));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _index_vue_vue_type_template_id_09ca6410___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=09ca6410& */ 33);
...
//
//
var graceChecker = __webpack_require__(/*! ../../common/graceChecker.js */ 61);var addressArr = __webpack_require__(/*! ./address.js */ 38);var _default = { data: function data() {return { address: [], multiArray: [], multiIndex: [18, 0], oneId: 0, twoId: 0, oldOwnerImageList: [], newOwnerImageList: [], vehicleLicenseImageList: [], registerImageList: [], statementImageList: [], taxImageList: [], oldOwner: '', oldOwnerCardDocument: '', oldOwnerPhone: '', newOwner: '', newOwnerCardDocument: '', newOwnerPhone: '', carId: '', carNumber: '', carname: '', carType: '', price: '', remark: '' };}, computed: _objectSpread({}, (0, _vuex.mapState)(['openid'])), mounted: function mounted() {this.initData(); //页面一加载调用赋值
